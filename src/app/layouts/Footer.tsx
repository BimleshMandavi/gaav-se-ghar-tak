...
const Footer = () => {
  return (
    <div>
      <div className="bg-[#3e1a00] flex justify-around items-center flex-col md:flex-row p-10">
        <div className="flex justify-evenly gap-5 flex-col">
          <h1 className="md:text-5xl text-[#e8e0c3]">Contact</h1>
          <p className="md:text-2xl text-[#e8c8ae]">info@gaavseghartak.com</p>
          <p className="text-2xl text-[#e8c8ae]">+91 9301269119</p>
        </div>
        <div className="flex justify-evenly gap-5 flex-col">
